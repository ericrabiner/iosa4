...
class MealList: ListBaseCD {
    ...
    override func viewDidLoad() {
        ...
        //frc = m.ds_frcForEntityNamed("Meal", withPredicateFormat: nil, predicateObject: nil, sortDescriptors: [NSSortDescriptor(key: "name", ascending: true)], andSectionNameKeyPath: nil)
        ...
        /*
         let limit = 125
         let letter = "o"
         frc = m.ds_frcForEntityNamed("Meal", withPredicateFormat: "quantity < %@ && name BEGINSWITH[cd] %@", predicateObject: [limit as AnyObject, letter as AnyObject], sortDescriptors: [NSSortDescriptor(key: "name", ascending: true, selector: #selector(NSString.caseInsensitiveCompare(_:)))], andSectionNameKeyPath: nil)
         */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Sample workflow segue code...
         ...
         //let vc = segue.destination as! MealList
        ...
        /*
         ...
         let vc = nav.viewControllers[0] as! MealDetail
